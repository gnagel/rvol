= rvol
	...
	Rvol enables investors to study market volatility from free data on the internet.
    ...
    Have a look at the current output here: https://gist.github.com/748840. The current implementation uses rupport for 
    the reporting so the data could be output in different formats like html, pdf, txt etc. I just use thecommand line 
    for now..
